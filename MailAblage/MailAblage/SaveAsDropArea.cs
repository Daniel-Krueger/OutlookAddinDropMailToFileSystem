        ...
        private void itemDropped(object sender, DragEventArgs e)
        {
            try
            {
                ...
                for (int fileIndex = 0; fileIndex < filenames.Length; fileIndex++)
                {
                    ...
                    string targetFolder = this.openFileDialog.FileName.Substring(0, this.openFileDialog.FileName.LastIndexOf("\\"));
                    string targetFileName = this.openFileDialog.FileName.Substring(targetFolder.Length + 1);
